      ...
      <main className="flex-1 container mx-auto px-4 py-6 md:py-8">
        ...
        {!searchQuery && (
          <div className="mb-8 md:mb-10">
            <div className="flex gap-2 md:gap-3 overflow-x-auto overflow-y-hidden pb-4 justify-start md:justify-center -mx-4 px-6 md:mx-0 md:px-0 snap-x snap-proximity" style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(155, 155, 155, 0.5) transparent' }}>
