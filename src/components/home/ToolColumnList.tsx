...
//                     ${isSponsored 
//                       ? "bg-yellow-500/5 hover:bg-yellow-500/10 border-l-2 border-l-yellow-500" // Premium Gold Effect
//                       : "hover:bg-muted/30"
//                     }`}
//                 >
                  
//                   {/* Rank/Index */}
//                   <span className={`text-xs w-4 font-mono ${isSponsored ? "text-yellow-600 font-bold" : "text-muted-foreground/50"}`}>
//                     {index + 1}.
//                   </span>
...
//                       {/* Premium Badge */}
//                       {isSponsored && (
//                         <span className="flex items-center gap-0.5 px-1.5 py-0.5 rounded-full bg-yellow-500/20 text-yellow-600 text-[10px] font-bold uppercase tracking-wide">
//                           Ad
//                         </span>
//                       )}
//                     </div>
