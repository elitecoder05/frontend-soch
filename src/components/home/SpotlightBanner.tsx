...
//   // --- DEBUG LOG ---
//   useEffect(() => {
//     console.log("SpotlightBanner mounted with tools:", tools);
//   }, [tools]);

//   if (!tools || tools.length === 0) {
//     console.warn("SpotlightBanner received empty tools array.");
//     return null;
//   }
...
//       <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-indigo-900 via-purple-900 to-black border border-white/10 shadow-2xl">
//         <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-primary/30 rounded-full blur-3xl opacity-50"></div>
...
//               {tool.name}
//             </h2>
//             <p className="text-gray-300 text-lg mb-8 max-w-xl line-clamp-2">
...
//                   className="px-8 py-3 bg-white/10 text-white font-semibold rounded-xl hover:bg-white/20 border border-white/10 backdrop-blur-sm transition-colors"
//                 >
//                   Visit Website
//                 </button>
//               )}
...
//               className="w-48 h-48 md:w-64 md:h-64 rounded-2xl bg-gradient-to-br from-white/10 to-transparent border border-white/20 backdrop-blur-md flex items-center justify-center shadow-2xl overflow-hidden"
//             >
//                {tool.iconUrl ? (
